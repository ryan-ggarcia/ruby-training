...
#select usado para selecionar alguma coisa dentro de um array ou hash

array = [1,2,34,4,5]
variavel = array.select do |a|
  a == 34 #aqui colocamos a nossa condição
end
puts variavel

#select com hash
hash = {0 => 'Zero', 1=> 'Um', 2=> 'Dois'}
variavel = hash.select do |key,values|
  key > 0
end 
print variavel